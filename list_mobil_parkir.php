    ...
    <table border="1" cellspacing="0" cellpadding="10">
        ...
        <tbody>
            ...
            while ($mobil = mysqli_fetch_array($query)) {
                ...
                echo "<td>";
                echo "<button style='margin-right:5px; margin-bottom:5px'><a href = 'form_update.php?id=" . $mobil['id'] . "'>Edit</a></button>";
                echo "<button style='margin-right:5px; margin-bottom:5px'><a href = 'data_mobil_keluar.php?id=" . $mobil['id'] . "'>Keluar</a></button><br>";
                echo "<button style='margin-right:5px;'><a href = 'form_delete.php?id=" . $mobil['id'] . "'>Hapus</a></button>";
                echo "<button> <a href = 'cetak.php?id=" . $mobil['id'] . "'target='_blank'>Cetak</a></button>";
                echo "</td>";
                echo "</tr>";
            }
